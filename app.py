...
# ฟังก์ชันดึงข้อมูลจากฐานข้อมูลออนไลน์ + ป้องกันข้อมูลพังค้างคลัง
def load_data():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if result:
                ...
                # ตรวจสอบและกรองเอาเฉพาะข้อมูลที่โครงสร้างถูกต้องจริงๆ
                clean_active = {}
                clean_in_phase = {}
...
def index():
    ...
    for b_id, items in in_phase_dict.items():
        ...
        in_phase_groups.append({
            "boss_id": b_id,
            "items": sorted_items,
            "min_time": sorted_items[0]["spawn_time_obj"]
        })
